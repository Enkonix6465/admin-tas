  ...
  return (
    <div className="min-h-screen h-screen bg-gradient-to-br from-cyan-50 to-orange-50 dark:bg-gradient-to-br dark:from-purple-900/20 dark:via-purple-800/30 dark:to-purple-900/20 flex overflow-hidden">
          ...
          <div className="relative workspace-dropdown">
            ...
            >
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 bg-gradient-to-r from-cyan-500 to-orange-500 dark:from-purple-500 dark:to-purple-600 rounded-lg flex items-center justify-center">
                  <Zap className="w-4 h-4 text-white" />
                </div>
                <span className="text-base font-bold bg-gradient-to-r from-cyan-600 to-orange-600 dark:from-purple-400 dark:to-purple-300 bg-clip-text text-transparent">TAS Enkonix</span>
              </div>
              ...
              <div className="absolute top-full left-0 mt-1 w-44 bg-white dark:bg-black/95 border border-gray-200 dark:border-purple-500/30 rounded-lg backdrop-blur-xl z-[9999] p-2">
                <div className="space-y-1">
                  ...
                  <button
                    ...
                    className="w-full text-left px-2 py-1 text-xs hover:bg-gray-100 dark:hover:bg-purple-500/20 rounded dark:text-purple-200"
                  >
                    + Create workspace
                  </button>
                </div>
          ...
          <nav className="space-y-2">
            ...
            <div>
              <button
                ...
                className="flex items-center justify-between w-full px-3 py-2 text-sm font-semibold text-gray-700 dark:text-white hover:bg-gray-100 dark:hover:bg-purple-500/20 rounded-lg transition-all duration-200"
              >
            ...
            <div>
              <button
                ...
                className="flex items-center justify-between w-full px-3 py-2 text-sm font-semibold text-gray-700 dark:text-white hover:bg-gray-100 dark:hover:bg-purple-500/20 rounded-lg transition-all duration-200 hover:shadow-sm"
              >
                <div className="flex items-center gap-2">
            ...
            <div>
              ...
              {expandedSections.tickets && (
                <div className="ml-5 mt-1 space-y-1">
                  ...
                  >
                    <Users className="w-4 h-4" />
                    <span className="text-black dark:text-white">Manage Team</span>
                  </Link>
                  <Link
                    to="/TeamMatrix"
                    onClick={closeSidebar}
                  ...
                  >
                    ...
                    <span className="text-black dark:text-white">Team Performance</span>
                  </Link>
                  <Link
                    to="/tasks"
                    onClick={closeSidebar}
                  ...
                  >
                    ...
                    <span className="text-black dark:text-white">Create Tasks</span>
                  </Link>
                  <Link
                    to="/ViewTasks"
                    onClick={closeSidebar}
                  ...
                  >
                    <CheckSquare className="w-4 h-4" />
                    <span className="text-black dark:text-white">View Tasks</span>
                  </Link>
                </div>
              )}
            </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Compact Top Header */}
        <header className="bg-gradient-to-r from-cyan-100/95 to-orange-100/95 dark:bg-gradient-to-r dark:from-black/95 dark:to-black/90 backdrop-blur-xl border-b border-cyan-300 dark:border-purple-500/40 px-4 py-2 shadow-lg shadow-cyan-500/20 dark:shadow-purple-500/20 relative z-dropdown">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div className="relative project-dropdown z-dropdown">
                <button
                  ...
                  className="flex items-center gap-1 text-xs text-gray-600 dark:text-purple-200 hover:bg-gray-100 dark:hover:bg-purple-700/40 rounded-lg px-2 py-1.5 transition-all duration-200 hover:shadow-sm relative z-dropdown"
                >
                  <span>Project Board </span>
                  <ChevronDown className="w-4 h-4" />
                </button>
                {projectOpen && (
                  <div className="absolute top-full left-0 mt-1 w-48 bg-white dark:bg-black/95 border border-gray-200 dark:border-purple-500/30 rounded shadow-lg z-max p-2">
                    <div className="space-y-1">
            ...
            <div className="flex items-center gap-2">
              <div className="relative filter-dropdown z-dropdown">
                <button
                  onClick={() => setFilterOpen(!filterOpen)}
                  className="flex items-center gap-1 px-3 py-1.5 text-xs border border-gray-200 dark:border-purple-500/30 rounded-lg bg-white dark:bg-black/90 text-gray-700 dark:text-purple-300 hover:bg-gray-50 dark:hover:bg-black/80 shadow-sm transition-all duration-200 hover:shadow-md dark:shadow-purple-500/20 relative z-dropdown"
                >
                ...
                {filterOpen && (
                  <div className="absolute right-0 top-full mt-1 w-48 bg-white dark:bg-black/95 border border-gray-200 dark:border-purple-500/30 rounded shadow-lg z-max p-3">
              ...
              <div className="relative sort-dropdown z-dropdown">
                <button
                ...
                {sortOpen && (
                  <div className="absolute right-0 top-full mt-1 w-40 bg-white dark:bg-black/95 border border-gray-200 dark:border-purple-500/30 rounded shadow-lg z-max p-2">
                    <div className="space-y-1">
                      <button
