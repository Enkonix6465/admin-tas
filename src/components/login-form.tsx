        ...
        <CardContent className="grid p-0 md:grid-cols-2">
            <form className="p-6 md:p-8" onSubmit={handleSubmit}>
              <div className="flex flex-col gap-6">
                ...
                <Button
                  type="submit"
                  className="neon-btn w-full h-12 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 transition-all duration-300 transform hover:scale-[1.02] shadow-lg text-white border-0"
                  disabled={isLoading}
                >
                  <span></span>
                  <span></span>
