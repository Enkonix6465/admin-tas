...
export function LoginForm({
  ...
  return (
    <div className={cn("flex flex-col gap-8", className)} {...props}>
      <Card className="overflow-hidden p-0 shadow-2xl border-0 bg-white/85 dark:bg-gray-900/85 backdrop-blur-2xl relative rounded-3xl">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div className="absolute top-20 left-8 w-12 h-12 bg-gradient-to-br from-white/20 to-white/10 dark:from-white/15 dark:to-white/5 backdrop-blur-xl rounded-2xl flex items-center justify-center shadow-2xl animate-float border border-white/30 dark:border-white/20">
            <svg className="w-6 h-6 text-purple-500/80 dark:text-purple-400/80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="absolute top-40 left-20 w-10 h-10 bg-gradient-to-br from-white/20 to-white/10 dark:from-white/15 dark:to-white/5 backdrop-blur-xl rounded-xl flex items-center justify-center shadow-2xl animate-float-delay-1 border border-white/30 dark:border-white/20">
            <svg className="w-5 h-5 text-indigo-500/80 dark:text-indigo-400/80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <CardContent className="grid p-0 md:grid-cols-2 min-h-[650px]">
              ...
              <div className="space-y-5">
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-white/90 dark:bg-gray-900/90 px-4 text-gray-500 dark:text-gray-400 backdrop-blur-sm font-medium rounded-lg">
                      Login with Others
                    </span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Button
                    ...
                    className="h-12 rounded-2xl border-gray-200/60 dark:border-gray-700/60 bg-white/80 dark:bg-gray-800/80 hover:bg-white/90 dark:hover:bg-gray-700/90 text-gray-700 dark:text-gray-300 transition-all duration-300 backdrop-blur-sm shadow-lg hover:shadow-xl font-medium"
                  >
          ...
          <div className="relative hidden md:block bg-gradient-to-br from-purple-600 via-purple-700 to-indigo-800 overflow-hidden rounded-r-3xl">
            ...
            <div className="absolute inset-0 pointer-events-none overflow-hidden">
              <div className="absolute top-16 right-12 w-14 h-14 bg-white/15 backdrop-blur-xl rounded-3xl flex items-center justify-center shadow-2xl animate-float border border-white/30">
                <svg className="w-7 h-7 text-white/80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
              </div>
              <div className="absolute top-32 left-8 w-12 h-12 bg-white/15 backdrop-blur-xl rounded-2xl flex items-center justify-center shadow-2xl animate-float-delay-1 border border-white/30">
                <svg className="w-6 h-6 text-white/80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <div className="absolute bottom-24 right-16 w-16 h-16 bg-white/15 backdrop-blur-xl rounded-3xl flex items-center justify-center shadow-2xl animate-float-delay-2 border border-white/30">
                <svg className="w-8 h-8 text-white/80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                </svg>
              </div>
              <div className="absolute bottom-40 left-12 w-13 h-13 bg-white/15 backdrop-blur-xl rounded-2xl flex items-center justify-center shadow-2xl animate-float-delay-3 border border-white/30">
                <svg className="w-6.5 h-6.5 text-white/80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
              </div>
              <div className="absolute top-48 right-8 w-11 h-11 bg-white/15 backdrop-blur-xl rounded-2xl flex items-center justify-center shadow-2xl animate-float border border-white/30">
                <svg className="w-5.5 h-5.5 text-white/80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
                </svg>
              </div>
              <div className="absolute top-64 left-20 w-10 h-10 bg-white/15 backdrop-blur-xl rounded-xl flex items-center justify-center shadow-2xl animate-float-delay-1 border border-white/30">
