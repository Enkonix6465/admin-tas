...
export default function EmployeeManagement() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 sm:p-6 text-gray-800 dark:text-white bg-gray-50 dark:bg-purple-900/80 min-h-screen">
      ...
      <div className="bg-white dark:bg-purple-800/60 shadow-lg p-4 rounded mb-8 animate-slide-up border border-gray-200 dark:border-purple-500/30">
        ...
        <div className="mt-6">
          ...
          <input
            ...
            className="border border-gray-200 dark:border-purple-500/30 w-full p-2 rounded bg-white dark:bg-purple-800 text-gray-900 dark:text-purple-100"
          />
        </div>
      </div>

      <div className="bg-white dark:bg-purple-800/60 shadow-lg p-4 rounded animate-fade-in border border-gray-200 dark:border-purple-500/30">
