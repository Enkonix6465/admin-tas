  ...
  const columns = [
    {
      ...
      title: "📋 Backlog",
      status: "pending",
      color: "from-gray-100/90 via-gray-50/80 to-gray-100/90",
      borderColor: "border-gray-300/40 dark:border-purple-400/30",
      iconColor: "text-gray-600 dark:text-purple-400",
      bgColor: "bg-gradient-to-br from-gray-50/60 via-white/80 to-gray-100/60 dark:from-purple-900/40 dark:via-gray-800/60 dark:to-purple-800/40",
      glassEffect: "bg-white/95 border border-gray-200/60 dark:bg-gradient-to-br dark:from-purple-900/60 dark:via-gray-800/80 dark:to-purple-800/60",
    ...
    },
    {
      ...
      title: "🚀 In Progress",
      status: "in_progress",
      color: "from-blue-100/90 via-blue-50/80 to-blue-100/90",
      borderColor: "border-blue-300/40 dark:border-purple-500/30",
      iconColor: "text-blue-600 dark:text-purple-300",
      bgColor: "bg-gradient-to-br from-blue-50/60 via-white/80 to-blue-100/60 dark:from-purple-800/40 dark:via-gray-800/60 dark:to-purple-700/40",
      glassEffect: "bg-white/95 border border-gray-200/60 dark:bg-gradient-to-br dark:from-purple-800/60 dark:via-gray-800/80 dark:to-purple-700/60",
    ...
    },
    {
      ...
      iconColor: "text-orange-600 dark:text-purple-200",
      bgColor: "bg-gradient-to-br from-orange-50/60 via-white/80 to-orange-100/60 dark:from-purple-700/40 dark:via-gray-800/60 dark:to-purple-600/40",
      glassEffect: "bg-white/95 border border-gray-200/60 dark:bg-gradient-to-br dark:from-purple-700/60 dark:via-gray-800/80 dark:to-purple-600/60",
    ...
    },
    {
      ...
      glassEffect: "bg-white/95 border border-gray-200/60 dark:bg-gradient-to-br dark:from-green-900/60 dark:via-gray-800/80 dark:to-emerald-800/60",
              ...
              <div className="relative p-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="md:col-span-2 space-y-6">
                    ...
                    {selectedTask.progress && Number.isFinite(selectedTask.progress) && selectedTask.progress > 0 && (
                      <div>
                        ...
                        <div className="flex items-center gap-3">
                          <div className="flex-1 bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                            <div
                              className="bg-blue-500 h-2 rounded-full transition-all duration-300"
                              style={{ width: `${Math.min(Math.max(selectedTask.progress || 0, 0), 100)}%` }}
                            />
                          </div>
