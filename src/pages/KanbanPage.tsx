...
const KanbanPage = () => {
  ...
  const TaskCard = ({ task }: { task: any }) => {
    ...
    const getCardBgColor = () => {
      ...
      switch (task.status) {
        case 'completed':
          return 'enhanced-glass-card border-blue-300/40 dark:border-purple-400/50 bg-gradient-to-br from-blue-50/70 via-gray-50/60 to-slate-50/70 dark:from-purple-900/20 dark:via-purple-800/30 dark:to-purple-900/20';
        case 'in_progress':
          return 'enhanced-glass-card border-blue-300/40 dark:border-purple-400/50 bg-gradient-to-br from-blue-50/70 via-sky-50/60 to-indigo-50/70 dark:from-purple-900/20 dark:via-purple-800/30 dark:to-purple-900/20';
        case 'review':
          return 'enhanced-glass-card border-gray-300/40 dark:border-purple-300/50 bg-gradient-to-br from-gray-50/70 via-slate-50/60 to-blue-50/70 dark:from-purple-900/20 dark:via-purple-800/30 dark:to-purple-900/20';
        default:
          return 'enhanced-glass-card border-gray-300/40 dark:border-purple-400/50 bg-gradient-to-br from-gray-50/70 via-slate-50/60 to-blue-50/70 dark:from-purple-900/20 dark:via-purple-800/30 dark:to-purple-900/20';
      }
    };
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative filter-dropdown">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 text-sm border border-gray-200 dark:border-purple-500/30 rounded-lg bg-white dark:bg-purple-800 text-gray-700 dark:text-purple-300 hover:bg-gray-50 dark:hover:bg-purple-700 transition-colors z-30 relative"
              >
              ...
              {filterOpen && (
                <div className="absolute right-0 top-full mt-2 w-80 bg-white dark:bg-purple-800 border border-gray-200 dark:border-purple-500/30 rounded-xl z-[9999] p-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <select
                          ...
                          className="w-full px-3 py-2 text-sm border border-gray-200 dark:border-purple-500/30 rounded-lg bg-white dark:bg-purple-800 text-gray-900 dark:text-purple-100 focus:outline-none focus:ring-2 focus:ring-purple-500"
                        >
      ...
      <div className="flex-1 min-h-0 p-6">
        ...
        {viewMode === "list" && (
          <div className="flex-1 w-full">
            <div className="bg-white/80 dark:bg-purple-800/80 backdrop-blur-xl rounded-2xl border border-gray-200/50 dark:border-purple-500/30 p-6">
